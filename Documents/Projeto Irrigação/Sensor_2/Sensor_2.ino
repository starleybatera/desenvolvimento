...
void Sensor(){ 
  ...
  bridge1.virtualWrite(V2,"SENSOR 2", tensao, umidade_media); // Enviando as leituras para o BLYNK_WRITE (V2) do Servidor para que sejam analisadas.
...
void Sleep(){ 
  Serial.println("");
  Serial.println("SENSOR-2 ENTRANDO EM MODO DE DESCANSO");
